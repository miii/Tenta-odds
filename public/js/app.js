...
},{"./local-js/jquery.pagescroll.js":3,"./local-js/jquery.tentachart.js":4,"jquery":1}],3:[function(require,module,exports){
...
(function ($) {
  ...
  $.fn.pagescroll = function (options, callback) {
    ...
    if (!settings.enabled) {
      return this.each(function () {
        for (i = 0; i < pageScrollElements.length; i++) if (pageScrollElements[i] == this) delete pageScrollElements[i];
      });
    }
    ...
    return this.each(function () {
      ...
      if (currentPageIndex > 0 && currentPageIndex < pageScrollElements.length) animateToPage(currentPageIndex);
    });
  };
})(jQuery);
