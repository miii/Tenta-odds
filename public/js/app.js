...
},{"_process":33,"fbjs/lib/invariant":30}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./components/Results.jsx":166,"./components/SearchView.jsx":168,"react":163,"react-dom":34}],165:[function(require,module,exports){
var React = require('react');
...
},{"../flux/AppConstants":169,"../flux/AppDispatcher":170,"react":163}],166:[function(require,module,exports){
(function (global){
var React = require('react');
var AppDispatcher = require('../flux/AppDispatcher');
...
var Results = React.createClass({
  ...
  componentWillUpdate: function () {
    if (this.state.visible) $('.view').pagescroll({
      disable: true
    });
  },
...
},{"../flux/AppConstants":169,"../flux/AppDispatcher":170,"../flux/stores/TentaStore":171,"../local-js/jquery.pagescroll.js":172,"../local-js/jquery.tentachart.js":173,"./ResultView.jsx":165,"jquery":31,"react":163}],167:[function(require,module,exports){
var React = require('react');
var AppDispatcher = require('../flux/AppDispatcher');
var TentaStore = require('../flux/stores/TentaStore');
var APP = require('../flux/AppConstants');
...
},{"flux":28}],171:[function(require,module,exports){
...
(function ($) {
  ...
  $.fn.pagescroll = function (options, callback) {
    ...
    if (settings.disable) {
      return this.each(function () {
        for (i = 0; i < pageScrollElements.length; i++) if (pageScrollElements[i] == this) {
    ...
    function animateToPage(pageIndex) {
      $('body').stop().animate({
        ...
        if (callback) callback.apply(null, [pageIndex]);
      });
    }
...
(function ($) {
  ...
  $.fn.tentachart = function (options) {
    ...
    return this.each(function () {
      ...
      if (settings.reset) percentProgress = percentTo = 0;
